    ...
    return [
        {
            ...
            "kind": "remove_fill_schema",
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_fill_contract_invalid",
            "category": "Contract",
        },
        {
            "mutation_id": "scene_missing",
            "base_task_id": "scene_decomposition__basic",
            "kind": "drop_fill_scene",
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_fill_scene_coverage_invalid",
            "category": "Planning Transfer",
        },
        {
            "mutation_id": "event_missing",
            "base_task_id": "event_grounding__basic",
            "kind": "drop_event_obligation",
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_fill_obligation_coverage_invalid",
            "category": "Planning Transfer",
        },
        {
            "mutation_id": "fabricated_reference",
            "base_task_id": "scene_grounding__basic",
            "kind": "fabricate_actor_ref",
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_fill_actor_invalid",
            "category": "Grounding",
        },
        {
            "mutation_id": "premature_reveal",
            "base_task_id": "reveal_control__basic",
            "kind": "leak_forbidden_reveal",
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_fill_forbidden_reveal",
            "category": "Reveal",
        },
        {
            ...
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_location_time_invalid",
            "category": "Temporal",
        },
        {
            "mutation_id": "dependency_cycle",
            "base_task_id": "dependency_transfer__dense",
            "kind": "forward_dependency",
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_fill_dependency_invalid",
            "category": "Dependency",
        },
        {
            "mutation_id": "resolution_missing",
            "base_task_id": "resolution_execution__basic",
            "kind": "drop_resolution_obligation",
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_fill_obligation_coverage_invalid",
            "category": "Resolution",
        },
        ...
        },
        {
            ...
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_fill_reference_invalid",
            "category": "Grounding",
        },
        {
            ...
            "target": "semantic_fill",
            "expected_reason_code": "compiler_scene_fill_provenance_invalid",
            "category": "Provenance",
        },
    ]
