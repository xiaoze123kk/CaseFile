...
.DESCRIPTION
v11 默认执行 30 次并轮换五类时间、空间与竞争矩阵场景。发布门槛为总计至少
...
param(
    ...
    [ValidateSet("brief-to-draft-v8", "brief-to-draft-v9", "brief-to-draft-v10", "brief-to-draft-v11")][string]$PromptVersion = "brief-to-draft-v11",
    [string]$ReportPath = ""
)
