...
def test_public_language_second_violation_fails_without_persisting_patch(
    ...
    assert task.prompt_version == "casefile-chat-v21"
...
def test_agent_chat_persists_reviewable_batch_and_atomic_apply_undo(
    ...
    with patch.dict(os.environ, {"CASEFILE_MASTER_KEY": master_key}):
        ...
        with factory() as session:
            ...
            assert frozen_input["router_version"] == "casefile-chat-router-v3"
        ...
        assert routed_request.prompt_version == "casefile-chat-v21"
...
def test_agent_collaboration_freezes_and_reviews_atomic_patch_batches(
    ...
    with patch.dict(os.environ, {"CASEFILE_MASTER_KEY": master_key}):
        ...
        assert prompt_version == "casefile-chat-v21"
