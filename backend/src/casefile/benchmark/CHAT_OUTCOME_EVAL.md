...
| 模式 | 命令 | 说明 |
|---|---|---|
| M0 校准 | `python -m casefile.benchmark chat-outcome --mode calibrate` | 30 条 Reference Solution 全过 + 12 条变异全抓；已进 `scripts/check.ps1` |
...
确定性安全失败（blank / forbidden / unnecessary / draft change）可直接判
