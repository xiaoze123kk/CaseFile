...
import { describeBriefRevision, type BriefRevisionChange } from "./brief-revision-summary";
import { IntakeQuestionsStage } from "./intake-questions-stage";
      ...
      {showLanding ? (
        ...
        >
          ...
          {!inEntryView && step === "questions" ? (
            <IntakeQuestionsStage
              intakeFrozen={intakeFrozen}
              currentDependencyInvalidation={currentDependencyInvalidation}
              questionsPending={questionsPending}
              hardQuestionsResolved={hardQuestionsResolved}
              generateBrief={generateBrief}
              questionGenerationMode={questionGenerationMode}
              error={error}
              questionGenerationFailed={questionGenerationFailed}
              sourceText={sourceText}
              visibleQuestions={visibleQuestions}
              questionPageIndex={questionPageIndex}
              answers={answers}
              updateAnswer={updateAnswer}
              openReachableStep={openReachableStep}
              setQuestionPageIndex={setQuestionPageIndex}
              markQuestionPending={markQuestionPending}
