...
export function WorkbenchIcon({
  ...
  const paths = {
    ...
    settings: (
      <>
        <path d="m6.5 1.5-.4 1.8-1.2.7-1.8-.5-1.5 2.6L3 7.3v1.4l-1.4 1.2 1.5 2.6 1.8-.5 1.2.7.4 1.8h3l.4-1.8 1.2-.7 1.8.5 1.5-2.6L13 8.7V7.3l1.4-1.2-1.5-2.6-1.8.5-1.2-.7-.4-1.8Z" />
