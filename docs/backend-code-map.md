...
| `backend/src/casefile/domain/narrative_compiler/planner_input.py`、`novel_plan.py` | N4.3 纯领域 PlannerInput v1/v2 冻结、确定性 PlannerView 投影与独立复验，以及 NovelPlanCandidate 引用/披露/Resolution/时序/DAG/Profile 门禁、服务器 SourceRef 派生、规范索引与稳定 NovelPlanIR hash。 |
